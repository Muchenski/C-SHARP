...
namespace WebProject.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(WebProjectContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            // Any() verifica se há algum registro em determinada tabela
            if(_context.SalesRecord.Any() || _context.Department.Any() || _context.Seller.Any())
            {
